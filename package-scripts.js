        ...
        db: {
            ...
            seed: {
                script: series(
                    'nps banner.seed',
                    'nps db.config',
                    runFast('./src/cross-infra/lib/seeds/')
                )
            },
            config: {
                script: runFast('./src/cross-infra/lib/ormconfig.ts')
            },
            drop: {
...
function banner(name) {
    return {
        ...
        script: runFast(`./src/cross-infra/lib/banner.ts ${name}`),
    };
}
